...
public:
    ...
    {
        return KYZisPublicFactory::self();
    }
    ...
    {
        return dynamic_cast<KTextEditor::View*> (m_buffer->firstView());
    } //looks stupid to me ...
    KTextEditor::Cursor end() const
    {
        return KTextEditor::Cursor( ((YZBuffer*)this)->end().x(), ((YZBuffer*)this)->end().y());
    }
    ...
    QChar character(const KTextEditor::Cursor&) const
    {
        return 0;
    } //TODO
    QStringList textLines(const KTextEditor::Range&, bool) const;
    KTextEditor::Cursor documentEnd() const
    {
        return KTextEditor::Cursor( ((YZBuffer*) this)->end().x(), ((YZBuffer*) this)->end().y());
    }
    ...
    bool startEditing (KTextEditor::View * = 0)
    {
        return false;
    } //TODO
    bool endEditing()
    ...
    YZBuffer *getBuffer() const
    {
        return m_buffer;
    }
    void setBuffer( YZBuffer *buffer )
    {
        m_buffer = buffer;
    }
...
public slots:
    ...
    void clearMarks();
    void setPixmap( MarkTypes, const QPixmap & )
    {} //TODO
    void setDescription( MarkTypes, const QString & )
    {} //TODO
...
public:
    void emitChars(int a, int b, const QString& c)
    {
        emit charactersInteractivelyInserted(a, b, c);
    }
