...
public:
    ...
    {
        return dynamic_cast<KTextEditor::Document*>( buffer );
    }
    ...
    {
        return ( modePool()->currentType() == YZMode::MODE_VISUAL_BLOCK );
    }
    bool setBlockSelection ( bool /*on*/ )
    {
        return true;
    } //TODO
    void copy () const
    ...
    virtual bool registerCompletionProvider(KTextEditor::CompletionProvider * /*provider*/)
    {
        return false;
    }
    virtual bool unregisterCompletionProvider(KTextEditor::CompletionProvider*)
    {
        return true;
    }
    virtual void invokeCompletion(enum KTextEditor::CompletionType /*type*/)
    {} //TODO
    ...
    void completionDone()
    {} //TODO
    void completingInProgress(bool val)
    {
        m_cc_cleanup = val;
    }
    ...
    void setKPart( KParts::ReadWritePart *part )
    {
        m_part = part;
    }
    KParts::ReadWritePart *getKPart() const
    {
        return m_part;
    }
